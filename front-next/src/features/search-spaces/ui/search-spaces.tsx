      ...
      <div className="p-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-12 py-3 bg-gray-100 dark:bg-gray-700 rounded-xl border-0 focus:ring-2 focus:ring-blue-500 text-sm text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
            value={searchQuery}
