              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="어떤 공간을 찾고 계신가요? (예: 공구를 보관할 장소가 필요합니다)"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="필요한 공간에 대해 자세히 설명해주세요"
                    rows={4}
                    className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800"
                    required
                  />
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="공간을 어떤 용도로 사용하실 예정인지 자세히 알려주세요"
                    rows={3}
                    className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800"
                    required
                  />
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-2">
                    <input
                      ...
                      onChange={e =>
                        handleInputChange('areaMin', e.target.value)
                      }
                      placeholder="최소 면적"
                      className="p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800"
                    />
                    <input
                      ...
                      onChange={e =>
                        handleInputChange('areaMax', e.target.value)
                      }
                      placeholder="최대 면적"
                      className="p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800"
                    />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="기타 특별한 요구사항이 있다면 자세히 적어주세요"
                    rows={3}
                    className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800"
                  />
                </div>
            ...
            <div className="flex justify-between mt-8">
              ...
              {currentStep < totalSteps ? (
                <Button
                  ...
                  disabled={
                    (currentStep === 1 &&
                      (!formData.title || !formData.spaceType)) ||
                    (currentStep === 2 &&
                      (!formData.region ||
                        !formData.budgetMin ||
                        !formData.budgetMax)) ||
